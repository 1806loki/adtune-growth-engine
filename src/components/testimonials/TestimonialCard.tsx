...
export function TestimonialCard({ testimonial, variant = "default" }: TestimonialCardProps) {
  ...
  if (variant === "compact") {
    return (
      <div className="flex-shrink-0 w-80 rounded-xl border border-border bg-surface-elevated p-6 transition-all duration-300 hover:scale-105 hover:shadow-elevated flex flex-col">
  ...
  return (
    <div className="w-full flex-shrink-0 scroll-snap-align-start md:w-80">
      <div className="h-full rounded-xl border border-border bg-surface-elevated p-6 transition-all duration-300 hover:scale-105 hover:shadow-elevated flex flex-col">
